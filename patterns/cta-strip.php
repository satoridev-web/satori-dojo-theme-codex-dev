...
<!-- wp:paragraph -->
<p>Invite visitors to join, contact the club, or visit a session.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-background-background-color has-primary-color has-text-color">Contact us</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
